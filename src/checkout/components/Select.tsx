		...
		<div className="space-y-0.5">
			<label className="flex flex-col">
				...
				<select
					...
					className="mt-1 block w-full rounded-none border-neutral-300 shadow-sm focus:border-neutral-300 focus:ring focus:ring-neutral-200 focus:ring-opacity-50"
				>
					{showPlaceholder && (
